...
--
-- Name: shared_container_type_information; Type: FK CONSTRAINT; Schema: public; Owner: jbernabe;
--

ALTER TABLE ONLY shared
    ADD CONSTRAINT shared_container_type_information FOREIGN KEY container_type_information(id_type);
